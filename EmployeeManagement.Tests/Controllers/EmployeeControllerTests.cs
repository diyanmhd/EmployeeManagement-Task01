...
namespace EmployeeManagement.Tests.Controllers
{
        ...
        : IClassFixture<WebApplicationFactory<Program>>
    {
        ...
        {
            var response = await _client.GetAsync("/api/employee/profile");

            Assert.Equal(HttpStatusCode.Unauthorized, response.StatusCode);
        }

        // ==========================================
        // TEST 2: Admin Role → 403
        // ==========================================
        [Fact]
        public async Task GetProfile_WithAdminRole_ReturnsForbidden()
        {
        ...
        // ==========================================
        // TEST 3: Employee Role → 200
        // ==========================================
        [Fact]
        public async Task GetProfile_WithEmployeeRole_ReturnsOk()
        {
